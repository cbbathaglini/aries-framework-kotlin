...
object W3cStaticContexts {

    private val CREDENTIALS_V1_RAW: String = """{
  "@context": {
    "@version": 1.1,
    "@protected": true,
    "id": "@id",
    ...
    private val DATA_INTEGRITY_V2_RAW: String = """{
  "@context": {
    "id": "@id",
    "type": "@type",
    "@protected": true,
    ...
    private val SECURITY_V1_RAW: String = """{
  "@context": {
    "id": "@id",
    "type": "@type",
    ...
    private val SECURITY_V2_RAW: String = """{
  "@context": [
    { "@version": 1.1 },
  ...
  "@context": {
    ...
    private val ED25519_V1_RAW: String = """{
  "@context": {
    "id": "@id",
    "type": "@type",
    "@protected": true,
    ...
    private val X25519_V1_RAW: String = """{
  "@context": {
    "id": "@id",
    "type": "@type",
    "@protected": true,
    ...
    private val SECP256K1_V1_RAW: String = """{
  "@context": {
    "id": "@id",
    "type": "@type",
    "@protected": true,
  ...
  "@context": {
    ...
    private val SCHEMA_ORG_RAW: String = """{
  "@context": {
    "type": "@type",
    "id": "@id",
    "HTML": { "@id": "rdf:HTML" },
    ...
    private val PRESENTATION_SUBMISSION_RAW: String = """{
  "@context": {
    "@version": 1.1,
    ...
    private val PURL_OB_V3P0_RAW: String = """{
  "@context": {
    "id": "@id",
    "type": "@type",
    ...
    private val VC_REVOCATION_LIST_2020_RAW: String = """{
  "@context": {
    "@protected": true,
    ...
    private val LINKED_VP_V1_RAW: String = """{
  "@context": [
    {
      "@version": 1.1,
      "@protected": true,
    ...
    val staticContexts: Map<String, String> by lazy {
        mapOf(
            "https://www.w3.org/2018/credentials/v1" to CREDENTIALS_V1_RAW,
            "https://w3id.org/security/data-integrity/v2" to DATA_INTEGRITY_V2_RAW,
            "https://w3id.org/security/v1" to SECURITY_V1_RAW,
            "https://w3id.org/security/v2" to SECURITY_V2_RAW,
            "https://w3id.org/did/v1" to DID_V1_RAW,
            "https://www.w3.org/ns/did/v1" to DID_V1_RAW,
            "https://w3.org/ns/did/v1" to DID_V1_RAW,
            "https://w3id.org/security/suites/ed25519-2018/v1" to ED25519_V1_RAW,
            "https://w3id.org/security/suites/x25519-2019/v1" to X25519_V1_RAW,
            "https://w3id.org/security/suites/secp256k1-2019/v1" to SECP256K1_V1_RAW,
            "https://www.w3.org/ns/odrl.jsonld" to ODRL_RAW,
            "http://schema.org/" to SCHEMA_ORG_RAW,
            "https://identity.foundation/presentation-exchange/submission/v1" to PRESENTATION_SUBMISSION_RAW,
            "https://purl.imsglobal.org/spec/ob/v3p0/context.json" to PURL_OB_V3P0_RAW,
            "https://w3c-ccg.github.io/vc-status-rl-2020/contexts/vc-revocation-list-2020/v1.jsonld" to VC_REVOCATION_LIST_2020_RAW,
            "https://identity.foundation/linked-vp/contexts/v1" to LINKED_VP_V1_RAW,
        )
    }
}
