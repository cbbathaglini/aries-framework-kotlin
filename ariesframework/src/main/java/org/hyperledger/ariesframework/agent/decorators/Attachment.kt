...
data class Attachment(
    ...
    fun getDataAsString(): String {
        // ✅ copia para val local para evitar smart-cast em var
        val b64 = data.base64
        return when {
    ...
    // ⚠️ isso aqui não precisa ser "fun <T> Attachment.getDataAsJsonByType"
    // mas deixei do jeito que você já tinha para não quebrar nada
